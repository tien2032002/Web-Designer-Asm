                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active">
                        ...
                        <div class="card menu mt-4 mb-5">
                            <h4 class="card-title"><?php echo $tagArray[$_GET['id']]?></h4>
                                <!-- begin: article list -->
                                ...
                                <?php
                                    ...
                                    foreach($newsArray as $news) {
                                        ...
                                        <div class="menu__item card">
                                            ...
                                            <a href="/tag/'.UrlNormal($tagArray[$news->tag]).'/'.$news->tag.'" class="btn btn-outline-success btn-override ms-2 mt-2 p-1" style="max-width: 56%">'.$tagArray[$news->tag].'</a>
